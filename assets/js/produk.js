...
for (var i = 0; i < data.length; i++) {
	...
	products += "<div class='product' data-kategori='" + kategori + "' data-nama='" + nama + "' data-deskripsi='" + deskripsi + "'><a class='button-produk' href='' data-obj='"+ i +"'><div class='product-inner text-left'><img src='" + foto + "' width='100%' height='200px'><br /><div class='nama-produk'>" + nama + "</div><p style='color:red;display:flex;float:left;padding-left:8px;padding-top:5px;font-size:9pt'>Rp</p><div class='harga-produk'>" + harga + "</div></a></div></div>";
...
$(".close-produk").click(function(){
  ...
  $("#products").css({"grid-template-rows":"292px auto"});
  $("#products").css({"grid-template-columns":"50% auto"});
  $("#products").css({"grid-row-gap":"0px"});
  $("#products").css({"grid-column-gap":"8px"});
...
$('#blog-click').click(function () {
    $('#blog-wrap #hidden-div').slideToggle({
      direction: "up"
    }, 200);
